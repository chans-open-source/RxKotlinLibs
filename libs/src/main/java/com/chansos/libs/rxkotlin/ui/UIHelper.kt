...
class UIHelper : OnHandlerMessage {
     ...
     * @return 加载对话框实例
     * */
    fun showLoading(activity: Activity, message: String = UIHelper.DEFAULT_LOADING_MESSAGE): MaterialDialog? =
     ...
     * @return 加载对话框实例
     * */
    fun showLoading(fragment: Fragment, message: String = UIHelper.DEFAULT_LOADING_MESSAGE): MaterialDialog? =
